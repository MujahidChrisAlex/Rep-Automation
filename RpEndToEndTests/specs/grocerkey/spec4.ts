...
describe("[Grocer Key] Go to grocer key's homepage, Login and select product and verify that Replenium widget is displayed on PDP", function () {
  ...
  it("should verify that replenium widget is present on the PDP", async () => {
    expect(await pageB.repleniumWidgetIsPresent()).toBe(true);
  });
