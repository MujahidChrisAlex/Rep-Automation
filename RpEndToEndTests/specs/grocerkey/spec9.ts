...
describe("[Grocer Key] Go to grocer key's homepage, Login and goto MSI page and verify MANAGE Next Order functionality", function () {
  ...
  it("should open MANAGE Next Order screen", async () => {
    msi.clickManageBtn();
  });
  ...
  it("should open MANAGE Next Order screen again", async () => {
    msi.clickManageBtn();
  });
